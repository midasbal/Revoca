...
const CLEANVERSE_URL = 'https://cleanverse.com';
    ...
    <footer className="site-footer">
      <div className="site-footer__inner">
        ...
        <div className="site-footer__links">
          <a className="site-footer__link" href="/docs#deployed-contracts" aria-label="The deployed contracts, in the docs">
            Contracts
          </a>
          <a
            ...
            target="_blank"
            rel="noreferrer"
            aria-label="Cleanverse, the verified-identity layer Revoca integrates"
          >
            Cleanverse
          </a>
          <a className="site-footer__link" href={REPO_URL} target="_blank" rel="noreferrer" aria-label="View the source on GitHub">
