 ...
 * legible version of those, not a separate story.
 */
    ...
    <div className="page-wrap docs">
      ...
      <section className="docs-section">
        ...
        <p className="docs-section__body">
          Four real pieces. Cleanverse&rsquo;s UAT sandbox is the source of A-Pass facts. The backend (deployable, never run
          on a user&rsquo;s machine) holds the Cleanverse API key and the attestor&rsquo;s signing key, neither ever reaches a
          browser. Monad testnet holds the contracts that actually decide eligibility and move funds. This app reads
          that chain state directly, live, and writes to it directly through your own wallet, the backend is never in
          that path.
        </p>
      ...
      <section className="docs-section">
        ...
        <p className="docs-section__body">
          ...
          freeze. Proven, not asserted: <code>contracts/test/GriefingBound.t.sol</code>, six properties, five of them
          fuzzed 5,000 runs each across every real collateral-ratio band, all passing.
        </p>
      </section>
      ...
      <section className="docs-section docs-section--last">
        <h2 className="docs-section__title">Source</h2>
        <p className="docs-section__body">
          The full contracts, backend, and this frontend are in one repository, open for inspection.
        </p>
